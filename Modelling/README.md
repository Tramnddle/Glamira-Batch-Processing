...
<p align="center">
  <img src="images/drawSQL-image-export-2026-01-22.png" alt="Dimensional Data Model" width="900">
</p>

*End-to-end batch analytics architecture using BigQuery and dbt (Raw → Staging → Snapshot → Mart).*

<p align="center">
  <img src="images/glamira_datamodel.jpg" alt="dbt model lineage" width="900">
</p>
